...
function AlertDialogDelete({ subCategoryId, children }) {
  const { products, deleteSubCategoryById } = useProductStore();
  return (
    <AlertDialog>
      ...
      <AlertDialogContent>
        ...
        <AlertDialogFooter>
          ...
          <AlertDialogAction
            onClick={() => deleteSubCategoryById(subCategoryId)}
...
export const subColumns = [
...

  {
    ...
    header: "Slug",
    cell: ({ row }) => row.original.subCategorySlug || "-",
  },
  {
    ...
    cell: ({ row }) => {
      return (
        <div className="flex items-center gap-2">
          ...
          <AlertDialogDelete subCategoryId={row.original._id}>
